...
(function() {
  ...
  twttr.txt.regexen.validGTLD = regexSupplant(RegExp(
    ...
    'xxx|xyz|zone|Ð´ÐµÑ‚Ð¸|Ð¾Ð½Ð»Ð°Ð¹Ð½|Ð¾Ñ€Ð³|ÑÐ°Ð¹Ñ‚|Ø¨Ø§Ø²Ø§Ø±|Ø´Ø¨ÙƒØ©|ã¿ã‚“ãª|ä¸­ä¿¡|ä¸­æ–‡ç½‘|å…¬å¸|å…¬ç›Š|åœ¨çº¿|æˆ‘çˆ±ä½ |æ”¿åŠ¡|æ¸¸æˆ|ç§»åŠ¨|ç½‘ç»œ|é›†å›¢|ì‚¼ì„±)' +
    '(?=[^0-9a-zA-Z@]|$))'));
  twttr.txt.regexen.validCCTLD = regexSupplant(RegExp(
    ...
    'ye|yt|za|zm|zw|Ð¼Ð¾Ð½|Ñ€Ñ„|ÑÑ€Ð±|ÑƒÐºÑ€|Ò›Ð°Ð·|Ø§Ù„Ø§Ø±Ø¯Ù†|Ø§Ù„Ø¬Ø²Ø§Ø¦Ø±|Ø§Ù„Ø³Ø¹ÙˆØ¯ÙŠØ©|Ø§Ù„Ù…ØºØ±Ø¨|Ø§Ù…Ø§Ø±Ø§Øª|Ø§ÛŒØ±Ø§Ù†|Ø¨Ú¾Ø§Ø±Øª|ØªÙˆÙ†Ø³|Ø³ÙˆØ¯Ø§Ù†|Ø³ÙˆØ±ÙŠØ©|Ø¹Ù…Ø§Ù†|ÙÙ„Ø³Ø·ÙŠÙ†|Ù‚Ø·Ø±|Ù…ØµØ±|Ù…Ù„ÙŠØ³ÙŠØ§|Ù¾Ø§Ú©Ø³ØªØ§Ù†|' +
